...
public class Pessoa implements Serializable {
	...
	@Column(unique=true)
	@NotEmpty(message="Campo do Rg não pode estar vazio..")
	@Pattern(regexp ="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}$",message="Informe o RG com os Digitos válidos Ex:xx.xxx.xxx-x")
	@CPF(message="CPF Informado Inválido...Informe um CPF válido Ex:674.402.757-30")
	private String cpf;
